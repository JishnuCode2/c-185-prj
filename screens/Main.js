              ...
              {Object.keys(data).map(category => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        this.state.selected === category ? "orange" : "white"
                    }
                  ]}
                  onPress={() =>
                    this.setState({
                ...
                >
                  <Text style={{fontSize: 10, fontWeight: [this.state.selected === category? "bold": ""]}}>
                    {category}
                  </Text>
                </TouchableOpacity>
              ))}
